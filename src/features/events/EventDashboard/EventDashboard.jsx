    ...
    return (
        ...
        <Grid>
            ...
            <Grid.Column width={6}>
                ...
                {this.state.isOpen && <EventForm selectedEvent={selectedEvent} updateEvent={this.handleUpdateEvent} createEvent={this.handleCreateEvent} cancel={this.handleCancel}/>}  
            </Grid.Column>
        </Grid>
